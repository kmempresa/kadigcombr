                ...
                {portfolio.assets.filter(a => !a.isRemoved).map((asset, index) => (
                  ...
                  >
                    <div className="flex items-start gap-3 mb-3">
                      <div className="w-12 h-12 rounded-lg bg-card flex items-center justify-center overflow-hidden flex-shrink-0 ring-1 ring-border">
                        {asset.logoUrl ? (
                          <img 
                            src={asset.logoUrl} 
                            alt={asset.ticker}
                            ...
                            onError={(e) => {
                              ...
                              (e.target as HTMLImageElement).parentElement!.innerHTML = 
                                `<span class="text-xs font-bold text-muted-foreground">${asset.ticker}</span>`;
                            }}
                          />
                        ) : (
                          <span className="text-xs font-bold text-muted-foreground">{asset.ticker}</span>
                        )}
                      </div>
