...
export const Footer = () => {
  return (
    <footer className="py-12 sm:py-20 relative">
      {/* CTA Section */}
      <div className="container mx-auto px-4 sm:px-6 mb-12 sm:mb-20">
        <motion.div
          ...
          viewport={{ once: true }}
          className="glass-strong rounded-2xl sm:rounded-3xl p-6 sm:p-12 text-center relative overflow-hidden"
        >
          {/* Glow */}
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col items-center gap-6 sm:gap-8 py-6 sm:py-8 border-t border-border">
          ...
          <div className="flex flex-col items-center gap-2 sm:gap-3">
            <img src={kadigLogo} alt="Kadig" className="h-5 sm:h-6 opacity-60" />
