...
const Auth = () => {
  ...
  return <div className="light-theme min-h-screen bg-background relative overflow-hidden fixed inset-0">
      {/* Background curved shapes */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Top right curve */}
        <div className="absolute -top-32 -right-32 w-80 h-80 sm:w-96 sm:h-96">
          <svg viewBox="0 0 400 400" className="w-full h-full">
            <path d="M400,0 Q400,200 200,200 Q400,200 400,400 L400,0 Z" fill="hsl(var(--muted))" opacity="0.6" />
          </svg>
        </div>
        ...
        <div className="absolute -bottom-32 -right-20 w-72 h-96 sm:w-96 sm:h-[500px]">
          <svg viewBox="0 0 400 500" className="w-full h-full">
            <path d="M400,0 Q200,150 250,300 Q300,450 400,500 L400,0 Z" fill="hsl(var(--muted))" opacity="0.4" />
          </svg>
        </div>
      ...
      <div className="relative z-10 min-h-screen flex flex-col px-5 sm:px-6 safe-area-inset-top safe-area-inset-bottom">
        ...
        delay: 0.2
          ...
          <div className="space-y-4 max-w-md">
            ...
            <div className="relative">
              <Input type="email" placeholder="E-mail:" value={email} onChange={e => setEmail(e.target.value)} className="h-14 sm:h-16 px-5 bg-card border-border rounded-2xl text-base text-foreground placeholder:text-muted-foreground focus:border-primary shadow-sm" />
            </div>

            {/* Password input */}
            <div className="relative">
              <Input type={showPassword ? "text" : "password"} placeholder="Senha:" value={password} onChange={e => setPassword(e.target.value)} className="h-14 sm:h-16 px-5 pr-14 bg-card border-border rounded-2xl text-base text-foreground placeholder:text-muted-foreground focus:border-primary shadow-sm" />
        ...
        delay: 0.4
          ...
          <div className="flex gap-3 sm:gap-4">
            {/* Signup button */}
            <button onClick={handleSignup} disabled={isSigningUp} className="flex-1 h-14 sm:h-16 px-4 bg-card border border-border rounded-2xl flex items-center justify-center gap-3 hover:bg-muted/50 active:scale-[0.98] transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            {/* Login button */}
            <button onClick={handleLogin} disabled={isLoading || !email.trim() || !password.trim()} className="flex-1 h-14 sm:h-16 px-4 bg-card border border-border rounded-2xl flex items-center justify-center gap-3 hover:bg-muted/50 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm">
